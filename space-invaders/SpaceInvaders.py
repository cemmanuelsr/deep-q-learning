...
parser = argparse.ArgumentParser(prog='SpaceInvaders')
parser.add_argument('-t', '--train', action='store_true')
parser.add_argument('-m', '--model', type=str, default='space_invaders')
...
if args.train:
    ...
    if args.gif:
        image_path = os.path.join('../demonstration/', f'{args.model}.gif')
        save_gif(image_path, frames)
